ad_page_contract {
    ...
    sim32 30/09/2020 Su richiesta della Regione Marche è stato cambiato il messaggio di errore
...
#sim32        Funzione impossibile per impianti annullati/Non attivi/Rottamati"  
	iter_return_complaint "Sarà possibile trasmettere RCEE e altri moduli solo dopo la riattivazione/validazione dell'impianto da parte dell'ente";#sim32
	ad_script_abort
    }
}
#fine modifica
