ad_page_contract {
    ...
    @cvs-id          coimbatc-gest.tcl
     ...
     USER  DATA       MODIFICHE
    ===== ========== =========================================================================
    but01 19/06/2023 Aggiunto la classe ah-jquery-date al campo dat_prev.
...
if {[form is_valid $form_name]} {
  ...
  # Lancio la query di manipolazione dati contenute in dml_sql
    ...
    switch $funzione {
        I {set return_url   "coiminco-cari2-gest?funzione=V&$link_gest"}
        V {set return_url   ""}
    }
