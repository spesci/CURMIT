...
<!--
    ...
    gac01 19/11/2018 Aggiunto campo data_ultima_manu, e flag_pagato
    ...
    <partialquery name="ins_dimp">
       <querytext>
		     ...
		     , data_arrivo_ente
                     ...
                     , tel_stato_coibent_idoneo_imp
                     , tel_linee_eletr_idonee      
                     , tel_assenza_perdite_circ_idraulico   
                     , tel_potenza_compatibile_dati_prog    
                     , tel_stato_coibent_idoneo_scamb       
                     , tel_disp_regolaz_controll_funzionanti
--                     , tel_assenza_trafil_valv_regolaz      
                     , tel_temp_est                         
                     , tel_temp_mand_prim                   
                     , tel_temp_rit_prim                    
                     , tel_potenza_termica                  
                     , tel_portata_fluido_prim              
                     , tel_temp_mand_sec                    
                     , tel_temp_rit_sec                     
                     , tel_check_coerenza_paramentri        
                     , tel_check_perdite_h2o                
                     , tel_check_install_involucro          
                     , tel_alimentazione                    
                     , tel_fluido_vett_term_uscita
		     , tel_alimentazione_altro
		     , tel_fluido_altro
       ...
       <querytext>
		     ...
		     , potenza            = :potenza
 		     ...
 		     , data_arrivo_ente   = :data_arrivo_ente
                     ...
                     -- ale01 teleriscaldamento 2403/2017 --
                     , tel_stato_coibent_idoneo_imp          = :tel_stato_coibent_idoneo_imp
                     , tel_linee_eletr_idonee                = :tel_linee_eletr_idonee
                     , tel_assenza_perdite_circ_idraulico    = :tel_assenza_perdite_circ_idraulico
                     , tel_potenza_compatibile_dati_prog     = :tel_potenza_compatibile_dati_prog
                     , tel_stato_coibent_idoneo_scamb        = :tel_stato_coibent_idoneo_scamb
                     , tel_disp_regolaz_controll_funzionanti = :tel_disp_regolaz_controll_funzionanti
                     --, tel_assenza_trafil_valv_regolaz       = tel_assenza_trafil_valv_regolaz
                     , tel_temp_est                          = :tel_temp_est
                     , tel_temp_mand_prim                    = :tel_temp_mand_prim
                     , tel_temp_rit_prim                     = :tel_temp_rit_prim
                     , tel_potenza_termica                   = :tel_potenza_termica
                     , tel_portata_fluido_prim               = :tel_portata_fluido_prim
                     , tel_temp_mand_sec                     = :tel_temp_mand_sec
                     , tel_temp_rit_sec                      = :tel_temp_rit_sec
                     , tel_check_coerenza_paramentri         = :tel_check_coerenza_paramentri
                     , tel_check_perdite_h2o                 = :tel_check_perdite_h2o
                     , tel_check_install_involucro           = :tel_check_install_involucro
                     , tel_alimentazione                     = :tel_alimentazione
                     , tel_fluido_vett_term_uscita           = :tel_fluido_vett_term_uscita
                     , tel_alimentazione_altro               = :tel_alimentazione_altro
                     , tel_fluido_altro                      = :tel_fluido_altro
                     -- ale01 teleriscaldamento 24/03/2017 --
                     , cod_tprc                              = :cod_tprc  --sim43
		     , flag_pagato                           = :flag_pagato --gac01
		     , cont_rend                             = :cont_rend --rom01
    ...
    <fullquery name="sel_dimp">
       <querytext>
		  ...
		  , iter_edit_data(a.data_arrivo_ente) as data_arrivo_ente
                  ...
                  , g.cod_potenza --sim08
                  -- ale01 teleriscaldamento 2403/2017 --
                  ,a.tel_stato_coibent_idoneo_imp
                  ,a.tel_linee_eletr_idonee
                  ,a.tel_assenza_perdite_circ_idraulico
                  ,a.tel_potenza_compatibile_dati_prog
                  ,a.tel_stato_coibent_idoneo_scamb
                  ,a.tel_disp_regolaz_controll_funzionanti
                  --,a.tel_assenza_trafil_valv_regolaz
                  ,iter_edit_num(a.tel_temp_est,0)            as tel_temp_est            --sim
                  ,iter_edit_num(a.tel_temp_mand_prim,0)      as tel_temp_mand_prim      --sim
                  ,iter_edit_num(a.tel_temp_rit_prim,0)       as tel_temp_rit_prim       --sim
                  ,iter_edit_num(a.tel_potenza_termica,0)     as tel_potenza_termica     --sim
                  ,iter_edit_num(a.tel_portata_fluido_prim,0) as tel_portata_fluido_prim --sim
                  ,iter_edit_num(a.tel_temp_mand_sec,0)       as tel_temp_mand_sec       --sim
                  ,iter_edit_num(a.tel_temp_rit_sec,0)        as tel_temp_rit_sec        --sim
--sim                  ,a.tel_temp_est
--sim                  ,a.tel_temp_mand_prim
--sim                  ,a.tel_temp_rit_prim
--sim                  ,a.tel_potenza_termica
--sim                  ,a.tel_portata_fluido_prim
--sim                  ,a.tel_temp_mand_sec
--sim                  ,a.tel_temp_rit_sec
                  ,a.tel_check_coerenza_paramentri
                  ,a.tel_check_perdite_h2o
                  ,a.tel_check_install_involucro
                  ,a.tel_alimentazione
		  ,a.tel_fluido_vett_term_uscita
                  ,a.tel_alimentazione_altro
                  ,a.tel_fluido_altro
                  -- ale01 teleriscaldamento 2403/2017 --
                  , a.cod_tprc    --sim43
    ...
    <fullquery name="sel_dimp_new">
       <querytext>
		  ...
		  , iter_edit_data(a.data_arrivo_ente) as data_arrivo_ente
                  ...
                  ,a.tel_disp_regolaz_controll_funzionanti
                  --,a.tel_assenza_trafil_valv_regolaz
                  ,iter_edit_num(a.tel_temp_est,2)            as tel_temp_est            --sim
                  ,iter_edit_num(a.tel_temp_mand_prim,2)      as tel_temp_mand_prim      --sim
                  ,iter_edit_num(a.tel_temp_rit_prim,2)       as tel_temp_rit_prim       --sim
                  ,iter_edit_num(a.tel_potenza_termica,2)     as tel_potenza_termica     --sim
                  ,iter_edit_num(a.tel_portata_fluido_prim,2) as tel_portata_fluido_prim --sim
                  ,iter_edit_num(a.tel_temp_mand_sec,2)       as tel_temp_mand_sec       --sim
                  ,iter_edit_num(a.tel_temp_rit_sec,2)        as tel_temp_rit_sec        --sim
--sim                  ,a.tel_temp_est
--sim                  ,a.tel_temp_mand_prim
--sim                  ,a.tel_temp_rit_prim
--sim                  ,a.tel_potenza_termica
...
--sim                  ,a.tel_temp_rit_sec
		  ...
		  ,a.tel_fluido_vett_term_uscita
                  -- ale01 teleriscaldamento 24/03/2017 --
                  , a.cod_tprc    --sim43
		  , flag_pagato as flag_pagato_dimp --gac01
		  , cont_rend --rom01
               from coimdimp$stn a
               left outer join coimmanu b on b.cod_manutentore  = a.cod_manutentore
               left outer join coimcitt c on c.cod_cittadino    = a.cod_responsabile
  ...
  -- nic02 , a.gen_prog
		...
		, case when a.flag_clima_invernale = 'S' then 'Sì' --gac02
		       when a.flag_clima_invernale = 'N' then 'No' --gac02
		       end as flag_clima_invernale_gen --gac02
		, case when a.flag_prod_acqua_calda = 'S' then 'Sì' --gac02
		       when a.flag_prod_acqua_calda = 'N' then 'No' --gac02
                       end as flag_prod_acqua_calda_gen --gac02
             from coimaimp e
