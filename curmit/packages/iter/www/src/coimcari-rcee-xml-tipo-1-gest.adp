...
<if @funzione@ eq "I">
  <table width="100%" border="0">
	...
	Da questa pagina &egrave; possibile caricare nuovi RCEE di tipo 1 utilizzando un file XML.
	<br><br>Le righe devono seguire le indicazioni fornite con il tracciato XML di riferimento per il caricamento in questione.
	<br>In presenza di targatura verificare attentamente che matricola e marca generatore siano corrette. In caso contrario il modello viene scartato.
