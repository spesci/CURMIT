ad_page_contract {
    ...
    USER  DATA       MODIFICHE
    ===== ========== =======================================================================
    but01 04/04/2023   Aggiunto il rapporto di esito "Mancata ispezione" visualizzato a video su tutti gli enti
...
<p align=center><big>Elenco Ispezioni</big>
"
...
<tr>
          <td><b>Num.Ispez.</b></td>
<td><b>Codice Impianto</b></td>
<td><b>Gen.</b></td>
<td><b>Comune</b></td>
<td><b>Indirizzo</b></td>
<td><b>Responsabile</b></td>
<td><b>Data_controllo</b></td>
<td><b>Num.Verbale</b></td>
<td><b>Data_verbale</b></td>
<td><b>Esito</b></td>
<td><b>Tipo-impianto</b></td>
 </tr>"
...
#but01 Aggiunto le rapporto di esito "Mancata ispezione"
 ...
 append stampa "
       <tr>
           ...
           <td>$indir&nbsp;</td>
           <td>$resp&nbsp;</td>
           <td>$data_controllo_edit&nbsp;</td>
           <td>$verb_n&nbsp;</td>
           <td>$data_verb_edit&nbsp;</td>
           <td>$esit&nbsp;</td>
    ...
    append stampa "
        <tr>
           <td colspan = 10 align=center><b>Nessun appuntamento selezionato</b></td>
        </tr>
        "
}
...
# lo trasformo in PDF
iter_crea_pdf [list exec htmldoc --webpage --header ... --footer ... --quiet --landscape --bodyfont arial --fontsize 09 --left 1cm --right 1cm --top 0cm --bottom 0cm -f $file_pdf $file_html]
