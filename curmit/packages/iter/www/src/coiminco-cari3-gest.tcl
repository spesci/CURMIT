ad_page_contract {
    ...
    USER  DATA       MODIFICHE
    ===== ========== =============================================================================
    but01 19/06/2023 Aggiunto la classe ah-jquery-date ai campo Data partenza.
...
set titolo              "Caricamento controlli da file esterno"
switch $funzione {
...
set cod_cinc_options [db_list_of_lists sel_cinc ""]
...
if {[form is_valid $form_name]} {
  ...
  # controlli standard su numeri e date, per Ins ed Upd
	...
	if {[string equal $cod_cinc ""]} {
	    element::set_error $form_name cod_cinc "Non ci sono campagne aperte"
	    incr error_num
	}
  ...
  # Lancio la query di manipolazione dati contenute in dml_sql
    ...
    switch $funzione {
        I {set return_url   "coiminco-cari3-gest?funzione=V&$link_gest"}
        V {set return_url   ""}
    }
