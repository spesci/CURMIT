       ...
       <querytext>
		       ...
		       ,e.numero    as numero_util
			    ...
			    when 'Z' then j.tel_alimentazione_altro
                       ...
                       ,j.tel_alimentazione as tel_alimentazione_tel --gac01
                       ,case j.tel_fluido_vett_term_uscita
                            when 'A' then 'Acqua calda'
                            when 'B' then 'Vapore'
                            when 'Z' then j.tel_fluido_altro
                        end as tel_fluido_vett_term_uscita
		       ,j.tel_fluido_vett_term_uscita as tel_fluido_vett_term_uscita_tel --gac01
		       ...
		       ,o.descr_tprc   --gac01
		       ,a.targa        --gac01
		       ,b.flag_clima_invernale --gac01
		       ,b.flag_prod_acqua_calda --gac01
                  from coimdimp j
    ...
    <fullquery name="sel_aimp_only_print">
       <querytext>
		       ...
		       ,e.numero    as numero_util
                       ...
                       , '______________' as ora_fine, null as rapp_contr
