ad_page_contract {
    ...
    USER  DATA       MODIFICHE
    ===== ========== =======================================================================
    but01 19/06/2023 Aggiunto la classe ah-jquery-date al campi: f_data1, f_data2.
...
#rom01set titolo "Parametri per stampa riepilogo controlli"
set titolo       "Statistica Incontri";#rom01
set button_label "Seleziona"
#rom01set page_title   "Parametri per stampa riepilogo controlli"
set page_title "Statistica Incontri";#rom01
...
# fine dpr74
#but01 Aggiunto la classe ah-jquery-date al campi: f_data1, f_data2.
...
if {[form is_valid $form_name]} {
    ...
    set link [export_url_vars f_data1 f_data2 flag_tipo_impianto caller funzione nome_funz nome_funz_caller]

   
    set return_url "coimsta5-layout?$link"    
