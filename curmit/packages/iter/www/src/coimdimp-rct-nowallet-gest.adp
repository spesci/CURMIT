...
<tr>
   ...
   <td width="12.5%" nowrap class=@func_i;noquote@>
       <a href="coimdimp-gest?funzione=I&flag_tracciato=NW&@link_gest;noquote@" class=@func_i;noquote@>Nuovo Allegato</a>
   </td>
   </else>
   <if @funzione@ ne I and @menu@ eq 1>
       ...
       <td width="12.5%" nowrap class=func-menu>
           <a href="@pack_dir;noquote@/coimdimp-rct-layout?@link_gest;noquote@&flag_ins=S" class=func-menu target="Stampa RCEE (Tipo 1)">Ins. Doc.</a>
       </td>
   </if>
   <else>
...
<if @funzione@ ne "V">
<br>
<b><font color=red>ATTENZIONE: procedendo con l'inserimento, verranno in automatico modificati i campi relativi al generatore</font></b>
</if>
...
<tr><td><table border=0 width="100%">
    <tr>
        ...
        <td width="17%" valign=top align=left class=form_title>Op. manutentore</td><!-- mis01 -->
...
<tr>
    <td valign=top align=right class=form_title>Pot. term. nom. utile (kW) @ast;noquote@</td><!-- mis01 -->
    <td valign=top><formwidget id="potenza">
        <formerror  id="potenza"><br>
        <span class="errori">@formerror.potenza;noquote@</span>
        </formerror>
    </td>
    <td valign=top align=right class=form_title>Pot. term. nom al focolare (kW) @ast;noquote@</td><!-- mis01 -->
...
<tr>
    ...
    <td valign=top align=right class=form_title>Tiraggio <if @flag_mod_gend@ eq "S">@ast_PFI;noquote@</if></td>
...
<if @cont_rend@ eq "S" and @conbustibile_solido@ eq "N">@ast;noquote@</if><!-- mis01 -->
      ...
      <td valign=top align=center class=form_title>Bacharach (n.) <if @flag_mod_gend@ eq "N"
                                                                    and @descr_combustibile@ eq "GASOLIO">@ast;noquote@</if></td><!-- mis01 -->
      <td valign=top align=center class=form_title>CO calc. @misura_co;noquote@
<if @cont_rend@ eq "S" and @conbustibile_solido@ eq "N">@ast;noquote@</if><!-- mis01 -->
</td>
...
<tr><td colspan=2 width=100%><table border=0 cellspacing=0 cellpadding=0 width=100%>
    <tr>
 <td valign=top align=center class=form_title>Depressione canale da Fumo (Pa)</td>
    <td valign=top align=center><formwidget id="tiraggio_fumi.@multiple_form_prfumi.conta_prfumi;noquote@">
...
<tr>
    ...
    <tr>
     ...
     <tr>
        <td valign=top align=right class=form_title>Data prossima Manutenzione</td>
