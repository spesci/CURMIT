...
<!--
    ...
    gac06 22/01/2019 Sandro mi ha detto che il campo "Potenza frigorifera nominale in raffrescamento"
    gac06            deve esporre la colonna pot_focolare_nom della tabella coimgend

    gac05 21/01/2019 aggiunti campi acquisti, acquisti2, scorta_o_lett_iniz, scorta_o_lett_iniz2, scorta_o_lett_fin, 
    gac05            scorta_o_lett_fin2 e campi elettricita

    gac04 15/01/2018 Aggiunto descr_comb, descr_cost e num_circuiti
    
    gac03 11/12/2018 Aggiunto flag_pagato

    gac02 19/11/2018 Aggiunto campo "data_ultima_manu"

    gac01 06/03/2018 Corretta anomalia portafoglio

    gab01 29/06/2017 Gestisco il nuovo campo che e' data_prox_manut

    sim08 17/11/2016 Gestito la potenza in base al flag_tipo_impianto

    sim07 27/06/2014 Gestito le tariffe per i vecchi impianti per la Regione Calabria	

    sim05 20/05/2016 Gestiamo le tariffe per il freddo
...
<queryset>
    ...
    <partialquery name="ins_dimp">
       <querytext>
		     ...
		     , data_arrivo_ente
                     ...
                     , fr_check_list_3 
                     , fr_check_list_4
		     , data_prox_manut --gab01
                     , cod_tprc   --sim24
		     , flag_pagato  --gac03
     		     , elet_esercizio_1            --gac05
		     , elet_esercizio_2            --gac05
		     , elet_esercizio_3            --gac05
		     , elet_esercizio_4            --gac05
		     , elet_lettura_iniziale       --gac05
		     , elet_lettura_finale         --gac05
		     , elet_consumo_totale         --gac05
		     , elet_lettura_iniziale_2     --gac05
		     , elet_lettura_finale_2       --gac05
		     , elet_consumo_totale_2       --gac05
		     , acquisti                    --gac05
		     , acquisti2                   --gac05
                     , scorta_o_lett_iniz          --gac05
    ...
    <partialquery name="upd_dimp">
       <querytext>
		     ...
		     , data_ultima_manu   = :data_ultima_manu --gac02
                     , gen_prog           = :gen_prog
		     ...
		     , data_prox_manut           = :data_prox_manut --gab01
                     , cod_tprc                  = :cod_tprc  --sim24
		     , flag_pagato               = :flag_pagato --gac03
     		     , acquisti                  = :acquisti            --gac05
		     , acquisti2                 = :acquisti2           --gac05
                     , scorta_o_lett_iniz        = :scorta_o_lett_iniz  --gac05
		     , scorta_o_lett_iniz2       = :scorta_o_lett_iniz2 --gac05
		     , scorta_o_lett_fin         = :scorta_o_lett_fin   --gac05
		     , scorta_o_lett_fin2        = :scorta_o_lett_fin2  --gac05
                     , elet_esercizio_1          = :elet_esercizio_1            --gac05
                     , elet_esercizio_2          = :elet_esercizio_2            --gac05
                     , elet_esercizio_3          = :elet_esercizio_3            --gac05
                     , elet_esercizio_4          = :elet_esercizio_4            --gac05
                     , elet_lettura_iniziale     = :elet_lettura_iniziale       --gac05
                     , elet_lettura_finale       = :elet_lettura_finale         --gac05
                     , elet_consumo_totale       = :elet_consumo_totale         --gac05
    ...
    <fullquery name="sel_dimp">
       <querytext>
		  ...
		  , iter_edit_data(a.data_ultima_manu) as data_ultima_manu --gac02
		  , a.gen_prog
                  , a.cod_manutentore
                  , a.cod_opmanu_new
                  , a.cod_responsabile
                  ...
                  , iter_edit_num(a.fr_nr_circuito,0)    as fr_nr_circuito
                  , a.fr_check_list_1 
                  , a.fr_check_list_2 
                  , a.fr_check_list_3 
                  , a.fr_check_list_4      
		  ...
		  , iter_edit_data(a.data_arrivo_ente) as data_arrivo_ente
                  ...
                  , a.cod_cind
		  , iter_edit_data(a.data_prox_manut) as data_prox_manut --gab01
                  , g.cod_potenza --sim07
                  , a.cod_tprc    --sim43
		  , a.flag_pagato  as flag_pagato_dimp --gac03
		  , iter_edit_num(a.acquisti, 2) as acquisti   --gac05
		  , iter_edit_num(a.acquisti2, 2) as acquisti2 --gac05
		  , iter_edit_num(a.scorta_o_lett_iniz, 2) as scorta_o_lett_iniz   --gac05
		  , iter_edit_num(a.scorta_o_lett_iniz2, 2) as scorta_o_lett_iniz2 --gac05
                  , iter_edit_num(a.scorta_o_lett_fin, 2) as scorta_o_lett_fin     --gac05
		  , iter_edit_num(a.scorta_o_lett_fin2, 2) as scorta_o_lett_fin2   --gac05
  		  , a.elet_esercizio_1         --gac05
                  , a.elet_esercizio_2         --gac05
                  , a.elet_esercizio_3         --gac05
                  , a.elet_esercizio_4         --gac05
                  , iter_edit_num(a.elet_lettura_iniziale, 2)   as elet_lettura_iniziale    --gac05
                  , iter_edit_num(a.elet_lettura_finale, 2)     as elet_lettura_finale      --gac05
                  , iter_edit_num(a.elet_consumo_totale, 2)     as elet_consumo_totale      --gac05
    ...
    <fullquery name="sel_aimp_old">
       <querytext>
	 select b.cod_manutentore  as cod_manutentore_old --rom01
      --rom01 a.cod_manutentore    as cod_manutentore_old
            , a.cod_responsabile   as cod_responsabile_old
            , a.cod_occupante      as cod_occupante_old
            , a.cod_proprietario   as cod_proprietario_old
            , a.cod_intestatario   as cod_int_contr_old
	 ...
	 left outer join coimmanu b on b.cod_manutentore = a.cod_manutentore
	                            or (b.cod_manutentore = a.cod_installatore 
                                    and a.cod_installatore = :cod_manu) --rom01 
	 left outer join coimcitt c on c.cod_cittadino   = a.cod_responsabile
	 left outer join coimcitt d on d.cod_cittadino   = a.cod_occupante
	 left outer join coimcitt e on e.cod_cittadino   = a.cod_proprietario
	 left outer join coimcitt f on f.cod_cittadino   = a.cod_intestatario
   ...
   <partialquery name="del_movi">
	...
	select iter_edit_num(a.importo,2) as tariffa
             , a.flag_tariffa_impianti_vecchi                                        --sim07
	     , a.anni_fine_tariffa_base                                              --sim07
             , iter_edit_num(a.tariffa_impianti_vecchi,2) as tariffa_impianti_vecchi --sim07
          from coimtari a
         where a.cod_potenza = :cod_potenza_old
   --sim05 and a.tipo_costo  = '1' 
	   and a.tipo_costo  = '8' -- sim05
    ...
    <fullquery name="sel_pote_fascia">
       <querytext>
	     ...
	     and flag_tipo_impianto = :flag_tipo_impianto --sim08 
       </querytext>
    </fullquery>
  ...
  -- nic03      , iter_edit_num(a.pot_focolare_nom,2) as pot_focolare_nom
                , iter_edit_num(a.pot_focolare_nom,2) as pot_focolare_nom --gac06 scommentato nic03 su richiesta di Sandro del 22/01/2019
                , iter_edit_num(a.pot_utile_nom,2) as pot_utile_nom -- nic03 (utile raffr.)
  --sim29              , iter_edit_num(a.pot_utile_lib,2) as pot_utile_lib -- nic03 (utile risc.)
                , iter_edit_num(a.pot_focolare_lib,2)     as pot_focolare_lib --sim29 
		, iter_edit_num(a.pot_utile_nom_freddo,2) as pot_utile_nom_freddo --sim28
		, a.num_circuiti --gac04
	     from coimaimp e
 ...
 -- nic02  , a.gen_prog
                ...
                , iter_edit_num(e.consumo_annuo,2) as consumo_annuo
  -- nic03      , iter_edit_num(a.pot_focolare_nom,2) as pot_focolare_nom
                , iter_edit_num(a.pot_focolare_nom,2) as pot_focolare_nom --gac06 scommentato nic03 su richiesta del 22/01/2019
                , iter_edit_num(a.pot_utile_nom,2) as pot_utile_nom -- nic03 (utile raffr.)
  --sim29              , iter_edit_num(a.pot_utile_lib,2) as pot_utile_lib -- nic03 (utile risc.)
                , iter_edit_num(a.pot_focolare_lib,2)     as pot_focolare_lib --sim29
		, iter_edit_num(a.pot_utile_nom_freddo,2) as pot_utile_nom_freddo --sim28
 ...
 -- nic02   where_gen
    ...
    --sim28            , pot_utile_nom    = :potenza
                , pot_utile_nom_freddo = :potenza --sim28
		, num_circuiti     = :num_circuiti --gac04
    --sim29            , pot_utile_lib    = pot_utile_lib -- nic03
                , pot_focolare_lib = :pot_focolare_lib--sim29
            where cod_impianto     = :cod_impianto
              and flag_attivo      = 'S'
              and gen_prog         = :gen_prog -- nic02
       </querytext>
