...
<tr>
   ...
   <td width="12.5%" nowrap class=@func_i;noquote@>
       <a href="coimdimp-gest?funzione=I&flag_tracciato=NF&@link_gest;noquote@" class=@func_i;noquote@>Nuovo Allegato</a>
   </td>
   </else>
   <if @funzione@ ne I and @menu@ eq 1>
       ...
       <td width="12.5%" nowrap class=func-menu>
           <a href="@pack_dir;noquote@/coimdimp-fr-layout?@link_gest;noquote@&flag_ins=S" class=func-menu target="Stampa RCCEE (Tipo 2)">Ins. Doc.</a>
       </td>
   </if>
   <else>
...
<tr><td>
   <table border=0 width=100%><tr>
    ...
    <th valign=top colspan=1 align=left class=form_title>C.TRATTAMENTO DELL'ACQUA</th>
    </tr><tr>
...
<tr>
    ...
    <td valign=top colspan=5><formwidget id="volimetria_risc">
...
<tr>
    ...
    <td valign=top colspan=2><formwidget id="combustibile">
...
<tr><td colspan=1 width=100%><table border=0 cellspacing=0 cellpadding=0 width=100%>
    <tr>
       <td valign=top align=center class=form_title>Surrisc. (&deg;C)</td>
       <td valign=top align=center class=form_title>Sottoraff. (&deg;C)</td>
       <td valign=top align=center class=form_title>T. condens. (&deg;C)</td>
 ...
 <tr><td colspan=1 align=left><table border=0 cellspacing=0 cellpadding=0>
    <tr>
...
<tr>
    ...
    <tr>
        <td valign=top align=right class=form_title>Data prossima Manutenzione @ast_CANCONA;noquote@</td>
