...
set nom       "Caricamento Schede impianto"
...
set titolo              "Caricamento Schede impianto da file esterno"
switch $funzione {
...
if {[form is_valid $form_name]} {
  ...
  # controlli standard su numeri e date, per Ins ed Upd
	...
	set nom_prog       "iter_aimp_cari_sche"
  ...
  # Lancio la query di manipolazione dati contenute in dml_sql
    ...
    switch $funzione {
        I {set return_url   "coimaimp-cari-sche?funzione=V&$link_gest"}
        V {set return_url   ""}
    }
