<!--
    ...
    rom06 12/01/2021 Le particolarità della Provincia di Salerno vengono ora messe sotto 
    rom06            la condizione su tutta la Regione Campania.

    rom05 25/02/2019 Aggiunti asterischi sui campi obbligatori su richiesta della Regione Marche

    rom04 31/07/2018 Surichiesta della Regione Marche cambiata dicitura iniziale.
...
<td class="func-menu-yellow2"><b>In questa scheda vengono richiesti i dati necessari per controllare<br>se l’impianto &egrave; gi&agrave; nel catasto e, nel caso non ci sia, per inserirlo in CURMIT</b></td>
  ...
  <else>
      ...
      <tr>
	    ...
	    <formwidget id="cod_tpim">
         ...
         <td valign="top" align="right" nowrap class="form_title">Combust.<font color=red>*</font></td><!--rom05-->
   ...
   <table border="0" width="100%" align="center" cellpadding="0" cellspacing="2">
      <tr>
	<td valign="top" align="right" class="form_title"><b>Responsabile</b><font color=red>*</font></td><!--rm05 aggiunto *-->
  ...
  <tr>
    <td width="18%" valign="top" align="right" nowrap class="form_title">Pot. termica nom.(kW)<font color=red>*</font></td><!--rom05 aggiunto *-->
...
<!-- gac01	 <td width="10%" valign="top" align="right" nowrap class="form_title">Fascia</td>
    ...
    <td width="20%" valign="top" align="right" nowrap class="form_title">Pot. elettrica nom.(kW)<font color=red>*</font></td><!--rom05 aggiunto *-->
...
<tr><td valign=top align=right class=form_title>POD
<if @coimtgen.regione@ eq "CAMPANIA" and @cod_manutentore;noquote@ eq "">
</if>
<elseif @coimtgen.ente@ eq "PPA"><!--rom07 Aggiunta elseif e il contenuto-->
</elseif>
<elseif @coimtgen.ente@ eq "PNA"><!--rom08 Aggiunta elseif e il contenuto-->
</elseif>
<else> 
<font color=red>*</font><!--rom05 aggiunto *-->
</else>
</td>
