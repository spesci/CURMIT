ad_page_contract {
    ...
    @cvs-id          coimestr-stampa-filter.tcl
...
set titolo       "Stampa Estrazione impianti per controlli"
...
if {[form is_request $form_name]} {
    ...
    element set_properties $form_name cod_zona         -value $cod_zona
...
if {[form is_valid $form_name]} {
    ...
    set cod_zona           [element::get_value $form_name cod_zona]
...
#    }
	...
	ad_returnredirect "coimestr-stampa-filter?[export_url_vars nome_funz nome_funz_caller tipo_estrazione cod_combustibile cod_cind anno_inst_da anno_inst_a cod_comune cod_via descr_topo descr_via cod_cinc cod_area flag_scaduto flag_oss flag_racc flag_pres flag_status cod_raggruppamento peso_min n_anomalie bacharach co rend_combust tiraggio cod_noin cod_anom data_scad flag_tipo_impianto tipo_generatore sistema_areazione tipo_locale cod_zona __refreshing_p]"
    }
    set return_url "coimestr-stampa?[export_url_vars nome_funz nome_funz_caller tipo_estrazione cod_combustibile cod_cind anno_inst_da anno_inst_a cod_comune cod_via descr_topo descr_via cod_cinc cod_area flag_scaduto flag_oss flag_racc flag_pres flag_status cod_raggruppamento peso_min n_anomalie bacharach co rend_combust cod_anom cod_noin tiraggio data_scad_chk flag_tipo_impianto cod_zona tipo_generatore sistema_areazione tipo_locale]"
#fine dpr74
